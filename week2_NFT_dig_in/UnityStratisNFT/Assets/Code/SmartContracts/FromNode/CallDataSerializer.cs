...
{
    public class CallDataSerializer
    {
        ...
        public ContractTxData Deserialize(byte[] smartContractBytes)
        {
        ...
        protected virtual ContractTxData SerializeCreateContract(byte[] smartContractBytes, int vmVersion, ulong gasPrice, RuntimeObserver.Gas gasLimit)
        {
        ...
        public ContractTxData SerializeCallContract(byte[] smartContractBytes, int vmVersion, ulong gasPrice, RuntimeObserver.Gas gasLimit)
        {
